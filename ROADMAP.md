...
Última actualización: 2026-04-22 (Clientes Sesión 5 ✅ — Sub-fases H (tab Finanzas con saldo por cobrar / crédito / saldo a favor, movimientos con toggle Abonos/Cargos/Todos, pagos parciales por apartado, modal editar límite MANAGER+ con motivo obligatorio, y 308 redirect desde `/reportes/clientes/[id]`) y I (tab Datos read-only con secciones colapsables, chips derivados + tags manuales con add/remove MANAGER+, tabla `CustomerEditLog` filtrada por rol, sección Fusiones recibidas con undo <30d))  
