...
Última actualización: 2026-04-22 (Clientes Sesión 3 ✅ — Sub-fase E: shell del perfil `/customers/[id]` con DetailHeader sticky + KPI strip + tab Resumen completo (alertas activas + timeline unificado + sidebar con saldo/crédito/notas pinned) + 2 modales nuevos rediseñados)  
